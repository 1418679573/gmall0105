package com.pigxia.gware.service.impl;


import com.alibaba.fastjson.JSON;

import com.pigxia.gware.util.ActiveMQUtil;
import com.pigxia.gware.util.HttpclientUtil;
import com.pigxia.gware.bean.WareInfo;
import com.pigxia.gware.bean.WareOrderTask;
import com.pigxia.gware.bean.WareOrderTaskDetail;
import com.pigxia.gware.bean.WareSku;
import com.pigxia.gware.enums.TaskStatus;
import com.pigxia.gware.mapper.WareInfoMapper;
...
public class GwareServiceImpl implements GwareService {
    ...
    public void sendToOrder(WareOrderTask wareOrderTask) throws JMSException{
            ...
            session.commit();
          //  对库存进行验货确认可以满足要求时，发布一个商品的消息队列给订单去消费
          // 修改的订单的发货状态为等待发货
    }
